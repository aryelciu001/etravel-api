    ...
    for (let i of flightData) {
        ...
        for (let j of i["Outbound"]["flights"]) {
            ...
            for (let u of preferenceTime) {
                ...
                if (u === "Afternoon") {
                    if (hour > 4 && hour < 12) {
                        time_score = (6 - Math.abs(hour + minute + second - 8.5) / 3.5) * 0.6;
                    } else if (hour > 11 && hour < 18) {
                        time_score = 6 - Math.abs(hour + minute + second - 15) / 3;
                    } else if (hour > 17 && hour < 5) {
                        if (hour < 5) hour += 24;
                        time_score = (6 - Math.abs(hour + minute + second - 23.5) / 5.5) * 0.6;
                    }
                }
                if (u === "Evening/Night") {
                    if (hour > 4 && hour < 12) {
                        time_score = (6 - Math.abs(hour + minute + second - 8.5) / 3.5) * 0.5;
                    } else if (hour > 11 && hour < 18) {
